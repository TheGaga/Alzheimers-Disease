...
[COMSOL file for simulation](AD_device_Model_only.mph) : Model of Aβ production, aggregation and clearance inside the microfluidic device. Results have been discarded to reduce file size. The simulation can be run again. The total file size including mesh and results will be approximately 450 Mb.
